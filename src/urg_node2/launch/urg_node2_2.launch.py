...
def generate_launch_description():
    ...
    lifecycle_node_1st = LifecycleNode(
        ...
        remappings=[('/scan', '/scan_1st')],#remappings=[('/scan', LaunchConfiguration('scan_topic_name_1st'))],
    ...
    lifecycle_node_2nd = LifecycleNode(
        ...
        remappings=[('/scan', '/scan_2nd')],#remappings=[('/scan', LaunchConfiguration('scan_topic_name_2nd'))],
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('scan_topic_name_1st', default_value='scan'),
        DeclareLaunchArgument('scan_topic_name_2nd', default_value='scan'),
        lifecycle_node_1st,
        lifecycle_node_2nd,
